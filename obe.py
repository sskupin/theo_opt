...
row = 1
row = gui.create_entry_with_latex(mainframe,r"Pulse amplitude $\sqrt{\pi}T_{\rm p}\Omega_{\rm R0}=$",E0_string,row)
...
row = gui.create_entry_with_latex(mainframe,r"Energy relaxation $T_{\rm p}/T_1=$",T1inv_string,row)
row = gui.create_spacer(mainframe,row)
