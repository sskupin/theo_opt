...
def initialize():
    global E0_save,C0_save,Delta_save,T1inv_save,T2inv_save,GE_save,ZL_save
    E0_string.set("2")
    C0_string.set("0")
    Delta_string.set("0")
    T1inv_string.set("0")
...
#            E[:,0] = E0/np.cosh(np.sqrt(np.pi)*T) # soliton with same amplitude and pulse area as unchirped Gaussian
