...
row = gui.create_launch_button(mainframe,python_string,'rt_graded_index.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'bloch_dr.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'bloch_dr_lambda.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'bloch_dr_kx.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'bloch_interface.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'bloch_stack_kx.py',column,row)
...
row = gui.create_launch_button(mainframe,python_string,'film_wg.py',column,row)
...
row = gui.create_launch_button(mainframe,python_string,'spp_ideal.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'spp_drude.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'strip_wg_fd.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'strip_wg_ei.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'fiber_wga.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'wg_array.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'prism_coupling.py',column,row)
row = gui.create_launch_button(mainframe,python_string,'endface_coupling.py',column,row)
...
row = gui.create_launch_button(mainframe,python_string,'3wm_exact.py',column,row)
