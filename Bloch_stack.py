...
row = gui.create_entry(mainframe,u"medium 1: N =",var_string[1],row)
...
row = gui.create_entry(mainframe,u"medium 2: N =",var_string[2],row)
...
row = gui.create_entry(mainframe,u"medium 3: N =",var_string[3],row)
