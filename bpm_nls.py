...
def show_manual():
    gui.show_manual("man/bpm_nls.png",title)    
...
row = gui.create_radiobutton(mainframe,['D =','+1','-1'],var_string[6],2,row)
row = gui.create_radiobutton(mainframe,[u'\u0393 =','+1','-1'],var_string[7],2,row)
