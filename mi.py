...
def show_manual():
    gui.show_manual("man/mi.png",title) 
...
row = gui.create_radiobutton(mainframe,['D =','+1','-1'],var_string[0],2,row)
row = gui.create_radiobutton(mainframe,[u'\u0393 =','+1','-1'],var_string[1],2,row)
row = gui.create_spacer(mainframe,row)
